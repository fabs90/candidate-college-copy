            ...
            <div className="w-1/2 flex flex-col justify-center items-center bg-white p-8">
                <div className="max-w-md w-full">
                    ...
                    <form className="mt-8">
                        ...
                        <div className="mb-4">
                            <label htmlFor="username" className="block text-sm font-medium" style={{ color: '#4A4159', opacity: 0.75 }}>
                                Username
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="mb-6">
                            <label htmlFor="confirm-password" className="block text-sm font-medium" style={{ color: '#4A4159', opacity: 0.75 }}>
                                Confirm Password
                            </label>
                            <input
                                type="password"
