export const valueSectionOnLanding = {
    subtitle: 'Who Are We',
...
export const classSectionPaket = {
    title: 'All-in-one',
...
export const values = [
    { id: 1, desc: 'Help student achieve their educational goals', image: 'value-1.png' },
    { id: 2, desc: 'Share inspirational and helpfull events', image: 'value-2.png' },
    { id: 3, desc: 'Spread knowledge through articles', image: 'value-3.png' },
]

export const articleSectionOnLanding = {
    subtitle: 'Our Articles',
    title: 'With Insightful and Actual Topic',
    description: 'Candidate College is an Education Platform that works to facilitate students in Indonesia at home and aboard to achieve a quality education system.'
}

export const eventSectionOnLanding = {
    subtitle: 'Our Events',
    title: 'With Insightful and Actual Topic',
    description: 'Candidate College is an Education Platform that works to facilitate students in Indonesia at home and aboard to achieve a quality education system.'
}
...
export const aboutCandidateCollege = 'Candidate College is an education platform organization that works to facilitate students in Indonesia at home and abroad to achieve a quality education system'

export const visionCandidateCollege = 'Vision of Candidate College is to achieve quality equally for all Indonesian students at home and abroad'

export const misionCandidateCollege = 'Mission of Candidate College is to achieve quality equally for all Indonesian students at home and abroad'

export const divisions = [
    'Social Media Specialist', 'Graphic Design', 'Content Writer', 'Content Creator', 'Podcast', 'Business Development', 'Web Development', 'BA Supervisor', 'Research & Development', 'People & Culture', 'Talent Engagement', 'Performance Management', 'Treasurer', 'Event Organizer', 'Secretary', 'Communication & CM', 'Public Relation'
]
